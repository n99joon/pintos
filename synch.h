...
struct lock 
  {
    ...
    //added
    struct list_elem lock_elem; //for the locks in the list of threads(multiple donation)
    int priority; //the priority of the holder. Used for convenience for multiple donation.
  };
