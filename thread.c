...
/*make a compare function for priority*/
bool cmp_priority(const struct list_elem *le1, const struct list_elem *le2, void *aux){
    struct thread *temp1 = list_entry (le1, struct thread, elem);
    struct thread *temp2 = list_entry (le2, struct thread, elem);
